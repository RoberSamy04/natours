...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var stripe = Stripe("pk_test_51RbiCbQFZAJKI8qmgVsopuDlZjzB1FOdGKEBphnTO7Sh75rVPoCIFgkBLNvHtRxcW1exjtcRWbotLKMCEeyygpz300UF1TwETW");
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 1:
          res = _context.v;
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "signed up  successfully ! Please confirm your Email");
            window.setTimeout(function () {
...
var emailConfirm = exports.emailConfirm = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(otp, email) {
    var res, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
        ...
        case 1:
          res = _context.v;
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "Email verified successfully!");
            window.setTimeout(function () {
  ...
  return function emailConfirm(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var verifyBtn = document.getElementById("submitBtn");
if (loginForm) {
